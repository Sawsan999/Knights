...
Knowledge_4All=And(Biconditional(AKnight,Not(AKnave)),
...
knowledge3 = And(Knowledge_4All,
            Implication(AKnight,Or(AKnight,AKnave)),
            #if Aknave then A said I am a knight
